...
def add_new_item(e):
    ...
    dialog = ft.AlertDialog(
        ...
        actions=[
            ft.TextButton("Submit", on_click=lambda _: save_and_confirm(product_id_field.value, product_name_field.value, category_field.value, description_field.value, dialog)),
...
def save_and_confirm(product_id, product_name, category, description, dialog):
...
def moduleInventory():
    return ft.Column(
        controls=[
            ...
            ft.ElevatedButton("Add New Item", on_click=add_new_item),
